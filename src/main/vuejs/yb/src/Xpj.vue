...
<template>
  <div class="layout" :class="{'layout-hide-text': spanLeft < 5}">
    ...
    <Menu mode="horizontal" active-name="3">
      ...
      <Menu-item name="5">
        <Icon type="loop" :size="iconSize"></Icon>
        <span @click="loadPlanLine" class="layout-text">{{lotteryType}}</span>
      </Menu-item>
    </Menu>
    ...
    <div class="layout-content-main">
      ...
      <Select v-model="qiSelected" placeholder="计划期数" style="width:100px">
        <Option v-for="item in qiList" :value="item.value" :key="item">{{ item.label }}
        </Option>
      </Select>
      <Select v-model="maSelected" v-bind:placeholder="maPlaceholder" style="width:100px">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      if (Cookies.get('lotteryType')) {
        this.lotteryType = Cookies.get('lotteryType');
        this.categoryUrl= Cookies.get('categoryUrl');
      }
    ...
    methods: {
      ...
      changeLotteryType(val){
        ...
        Cookies.set('lotteryType', this.lotteryType);
        Cookies.set('categoryUrl', this.categoryUrl);
        this.setList();
        this.loadPlanLine();
      },
      setList(){
